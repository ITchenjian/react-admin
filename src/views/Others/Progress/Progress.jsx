                ...
                <Row gutter={8}>
                    <Col span={12}>
                        ...
                        <div className='base-style'>
                            ...
                            <Progress type='circle' percent={this.state.percent} size='default' />
                            <ButtonGroup>
                    ...
                    <Col span={12}>
                        <div className='base-style'>
                            ...
                            <Progress type='circle' percent={70} status='exception' size='default' />
                            <Progress type='circle' percent={100} strokeWidth={6} size='default' />
                        </div>
                        <div className='base-style'>
                            <Divider orientation='left'>自定义文字</Divider>
                            <Progress type='circle' percent={75} format={percent => `${percent} Days`} size='default' />
                            <Progress type='circle' percent={100} format={() => 'Done'} size='default' />
                        </div>
                    </Col>
                </Row>
            </Layout>
